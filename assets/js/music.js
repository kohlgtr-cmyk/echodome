// ============================================
// ECHODOME — MUSIC CONFIG
// Adicione suas músicas aqui
// ============================================

const ECHODOME_TRACKS = [
    {
        id: 1,
        title: "Love Story",
        artist: "EchoDome",
        duration: "4:05",           // duração exibida (só visual por enquanto)
...
'Cause we were both young when I first saw you`,
    ...
    },
    {
        ...
        artist: "EchoDome",
        duration: "5:01",
        src: "assets/audio/eu-nao-queria-sentir-assim.mp3",
        cover: "assets/img/logo.jpeg",
        lyrics:`[Verse 1]
...
From this lost dreams town`,
        ...
        artist: "EchoDome",
        duration: "5:01",
        src: "assets/audio/between-the-lines.mp3",
        cover: "assets/img/logo.jpeg",
        lyrics: `[Verse 1]
It’s 2 a.m. again.
I’m awake.
...
between the lines.`,
    ...
    // Para adicionar mais músicas, copie o bloco acima e cole aqui
    // Lembre de colocar os arquivos .mp3 na pasta assets/audio/
    ];
